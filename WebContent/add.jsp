				...
				<div class="col-xs-10">
					...
					<form action="${ctx }/fruit/add" method="post">
						<table
							...
							<thead>
								<tr class="info">
									<th class="text-center" colspan="2" align="center">产品信息</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									...
									<td><input name="name" type="text" class="form-control"
										placeholder="水果名" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>价格：</td>
									<td><input name="price" type="text" class="form-control"
										placeholder="价格" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>库存：</td>
									<td><input name="stock" type="text" class="form-control"
										placeholder="库存" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>原产地：</td>
									<td><input name="place" type="text" class="form-control"
										placeholder="原产地" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>进货时间：</td>
									<td><input name="time" type="text" class="form-control"
										placeholder="进货时间" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>属性：</td>
									<td><input name="nature" type="text" class="form-control"
										placeholder="属性" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>颜色：</td>
									<td><input name="color" type="text" class="form-control"
										placeholder="颜色" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>

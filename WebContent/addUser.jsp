			...
			<div class="row ">
				...
				<div class="col-xs-10">
					...
					<ol class="breadcrumb">
						...
						<li class="active">GoodsManage - add</li>
					</ol>
					<form action="${ctx }/fruit/add" method="post">
						<table
							class="table table-bordered table-striped text-center bg-info">
							<thead>
								<tr class="info">
									<th class="text-center" colspan="2" align="center">员工信息</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td>员工工号：</td>
									<td><input name="userNumber" type="text" class="form-control"
										placeholder="员工工号" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>员工登录名：</td>
									<td><input name="loginName" type="text" class="form-control"
										placeholder="员工登录名" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>真实姓名：</td>
									<td><input name="userName" type="text" class="form-control"
										placeholder="真实姓名" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>入职时间：</td>
									<td><input name="entryTime" type="text" class="form-control"
										placeholder="入职时间" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>薪水：</td>
									<td><input name="salary" type="text" class="form-control"
										placeholder="薪水" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>
									<td>联系方式：</td>
									<td><input name="tel" type="text" class="form-control"
										placeholder="联系方式" aria-describedby="basic-addon2" /></td>
								</tr>
								<tr>

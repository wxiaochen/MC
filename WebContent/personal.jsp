			...
			<div class="row ">
				...
				<div class="col-xs-10">
					...
					<ol class="breadcrumb">
						...
						<li class="active">PersonalManage - selectPersonal</li>
					</ol>
					<form action="">
						<table
							...
							<thead>
								<tr class="info">
									<th class="text-center" colspan="2" align="center">个人信息</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td>工号：</td>
									<td class="form-control" aria-describedby="basic-addon2">${userinfo.userNumber }</td>
								</tr>
								<tr>
									<td>登录名：</td>
									<<td class="form-control" aria-describedby="basic-addon2">${userinfo.loginName }</td>
								</tr>
								<tr>
									<td>真实姓名：</td>
									<td class="form-control" aria-describedby="basic-addon2">${userinfo.userName }</td>
								</tr>
								<tr>
									<td>入职时间：</td>
									<td class="form-control" aria-describedby="basic-addon2">${userinfo.entryTime }</td>
								</tr>
								<tr>
									<td>薪水：</td>
									<td class="form-control" aria-describedby="basic-addon2">${userinfo.salary }</td>
								</tr>
								<tr>
									<td>联系方式：</td>
									<td class="form-control" aria-describedby="basic-addon2">${userinfo.tel }</td>
								</tr>
							</tbody>
						</table>
					</form>
